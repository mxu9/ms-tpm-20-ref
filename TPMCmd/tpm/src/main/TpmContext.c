    ...
    UINT32 contextId)
{
  ...
  printf("_PopContext from slot[%d]\n", i);
...
void SwitchTpmContext(
    UINT32 contextId)
{
  printf(">>SwitchTpmContext contextId=%d, current=%d\n", contextId, g_CurrentTpmContextId);
...
_finish:
  printf("<<SwitchTpmContext done. current=%d\n", contextId);
}
